    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center space-y-6">
      ...
      {apiKey && (
        <div className="flex flex-col items-center space-y-3">
          ...
          <button onClick={() => router.push("/")} className="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg shadow-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400">
            홈으로 가기
          </button>
        </div>
      )}
