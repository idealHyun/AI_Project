			...
			messages: [
				{
					role: "system",
					content:
						"너는 제품 설명을 바탕으로 제품군을 특정하고 주요 특징을 분석하여, 사용자가 주요 특징을 일상적이고 쉬운 표현으로 바꿔주는 AI이다. 답변은 마크다운 형식(```)은 없이 객체에 담아서 보내줘",
				},
			...
			messages: [
				{
					role: "system",
					content:
						"너는 제품군과 주어진 제품들의 특징을 이용하여 일상적이고 쉬운 표현을 사용한 질문을 만들어, 사용자가 대답하기 쉬운 질문을 만들어주는 AI이다. 답변은 마크다운 형식(```)은 없이 객체에 담아서 보내줘",
				},
				{ role: "user", content: prompt },
			],
		});
